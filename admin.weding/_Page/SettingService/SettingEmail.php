<?php
    ...
    $IjinAksesSaya=IjinAksesSaya($Conn,$SessionIdAkses,'W17gNhweJFqOqljCV1J');
                ...
                <form action="javascript:void(0);" id="ProsesSettingEmail">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small class="credit">
                                        <code class="text text-grayish">
                                            URL yang mengarah pada service gateway.
                                        </code>
                                    </small>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <label class="form-label" for="url_provider">URL Provider</i></label>
                                </div>
                                <div class="col-md-8">
