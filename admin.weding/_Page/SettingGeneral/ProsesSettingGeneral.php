        ...
        if(empty($_POST['kata_kunci'])){
            ...
            if(empty($_POST['deskripsi'])){
                ...
                if(empty($_POST['author'])){
                    echo '<span class="text-danger">Nama Author Tidak Boleh Kosong!</span>';
                }else{
                        ...
                        if(empty($_POST['email_bisnis'])){
                            ...
                            if(empty($_POST['telepon_bisnis'])){
                                ...
                                if(empty($_POST['base_url'])){
                                    ...
                                    if(empty($_POST['landing_page_url'])){
                                        echo '<span class="text-danger">Base URL Landing Page Tidak Boleh Kosong!</span>';
                                    }else{
