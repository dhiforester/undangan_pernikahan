<?php
    ...
    if(empty($SessionIdAkses)){
        ...
        if(empty($_POST['id'])){
            ...
            //Buka Informasi
            $nama=GetDetailData($Conn,'testimoni','id',$id,'nama');
            $pesan=GetDetailData($Conn,'testimoni','id',$id,'pesan');
            $datetime=GetDetailData($Conn,'testimoni','id',$id,'datetime');
            $status=GetDetailData($Conn,'testimoni','id',$id,'status');
            if($status=="Draft"){
